...
// Safely render metafield values that may be strings or legacy objects
...
// Normalize tags which may come back as an array or a string
export function getTags(tags: string[] | string | undefined): string[] {
  if (!tags) return []
